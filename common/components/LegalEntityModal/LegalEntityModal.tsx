...
import { CloseInnIcon } from "@/public/icons/close-inn";
import { SuccessInnIcon } from "@/public/icons/success-inn";
...
const LegalEntityModal = ({ isVisible, onClose }: ModalProps) => {
  ...
  const fillInnData = useCallback(() => {
    ...
    setCurrentAccount("123654789654123");
    setBik("");
    setBankName("");
    setCorrespondingAccount("12365478965412");
  }, []);
